// Файл: Form1.cs
// Призначення: Реалізація графічного інтерфейсу користувача (GUI).
// Забезпечує введення початкових даних, вибір методу обернення, 
// відображення результатів обчислень та взаємодію з іншими модулями системи.
...
namespace CourseWork
{
    ...
    public partial class Form1 : Form
    {
        ...
        // Значення округлюються до 6 десяткових знаків для зручності відображення.
