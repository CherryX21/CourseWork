// Файл: BlockInverter.cs
// Призначення: Реалізація алгоритму обернення матриці методом розбиття на клітки.
// Забезпечує рекурсивне або ітераційне розбиття матриці на підматриці, 
// виконання операцій над блоками та обчислення доповнення Шура.
